...
const onSubmit = (data: RegisterBody) => {
  registerUser(data, {
    ...
    onError: (error) => {
      ...
      const errorMessage = axiosError.response!.data as unknown as ApiResponse<null>
      toast.error(errorMessage.message ?? "Error del servidor. Inténtalo de nuevo más tarde.");
    },
  });
};
