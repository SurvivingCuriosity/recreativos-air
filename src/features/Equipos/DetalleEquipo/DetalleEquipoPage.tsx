        ...
        {equipo.jugadores.map((jugador, index) => {
          if (jugador.idUsuario === null)
            return (
              <div
                ...
                className="justify-between w-full flex items-center gap-2 h-auto bg-neutral-800 min-w-40 p-2 px-4 rounded-md text-neutral-400"
              >
          ...
          return (
            <Link
              ...
              className="w-full flex items-center gap-2 h-auto bg-neutral-800 min-w-40 p-2 px-4 rounded-md text-neutral-400"
            >
              <FontAwesomeIcon icon={faUser} className="mr-1" />
              {jugador.nombre}
              {user?.id === jugador.idUsuario && (
